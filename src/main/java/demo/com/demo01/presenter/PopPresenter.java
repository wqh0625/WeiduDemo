...
public class PopPresenter extends BasePresenter {

    public PopPresenter(DataCall consumer) {
        super(consumer);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return NewWorkHttp.getNetWorks().create(IRequest.class).getOneCategory();
    }
}
