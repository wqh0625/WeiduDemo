...
public class CircleCancelPresenter extends BasePresenter {
    public CircleCancelPresenter(DataCall consumer) {
        super(consumer);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        Observable<Result> bannerData = iRegister.getcacelDianZan((int) args[0],(String) args[1],(int) args[2] );
        return bannerData;
    }
}
