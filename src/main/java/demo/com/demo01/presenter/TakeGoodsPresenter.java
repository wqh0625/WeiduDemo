...
public class TakeGoodsPresenter extends BasePresenter {


    public TakeGoodsPresenter(DataCall consumer) {
        super(consumer);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        Observable<Result> bannerData = iRegister.takeGoods((int) args[0], (String) args[1],(String) args[2]);
        return bannerData;
    }
}
